...
namespace FLIMage
{
    public partial class splashScreen : Form
    {
        ...
        public splashScreen()
        {
            ...
            parameters.spcData.BoardType = ""; //Try not opening anything.
            ...
            if (ApplicationDeployment.IsNetworkDeployed)
            {
                ...
                versionText = ApplicationDeployment.CurrentDeployment.CurrentVersion.ToString(3);
            }
            else
            {
                versionText = System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString(3);
