...
namespace FLIMage
{
    public partial class ZoZoMotorControl : Form
    {
        MotorCtrl motorCtrl;
        ...
        public ZoZoMotorControl()
        {
            InitializeComponent();
        }

        public ZoZoMotorControl(String comPort)
        {
            ComPort = comPort;
            InitializeComponent();
        }

        private void ZoZoMotorControl_Load(object sender, EventArgs e)
        {
        ...
        private void ZoZoMotorControl_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (motorCtrl != null && motorCtrl.connected)
            {
                motorCtrl.MotH -= MotorListener;
